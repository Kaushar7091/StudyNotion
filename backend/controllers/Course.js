...
exports.getInstructorCourses = async (req, res) => {
  try {
    ...
    // Find all courses belonging to the instructor with populated curriculum
    ...
    // Calculate total duration for each course dynamically
    ...
    // Return the instructor's courses with computed durations
    res.status(200).json({
      success: true,
